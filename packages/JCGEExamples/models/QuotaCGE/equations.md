...
$$
\mathrm{pz}_{i} = \mathrm{ay}_{i} \cdot \mathrm{py}_{i} + \sum_{j \in \{\mathrm{BRD}, \mathrm{MLK}\}} \mathrm{ax}_{j,i} \cdot \mathrm{pq}_{j} + 0.0
$$
...
$$
Td = tau\_d \cdot \left(\sum_{h \in \{\mathrm{CAP}, \mathrm{LAB}\}} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} + \sum_{i \in \{\mathrm{BRD}, \mathrm{MLK}\}} \mathrm{RT}_{i} + 0.0\right)
$$
...
$$
Sp = ssp \cdot \left(\sum_{h \in \{\mathrm{CAP}, \mathrm{LAB}\}} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} + \sum_{i \in \{\mathrm{BRD}, \mathrm{MLK}\}} \mathrm{RT}_{i} + 0.0\right)
$$
...
$$
\mathrm{Xp}_{i} = \frac{\mathrm{alpha}_{i} \cdot \left(\sum_{h \in \{\mathrm{CAP}, \mathrm{LAB}\}} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} - Sp - Td + \sum_{j \in \{\mathrm{BRD}, \mathrm{MLK}\}} \mathrm{RT}_{j} + 0.0\right)}{\mathrm{pq}_{i}}
$$
...
$$
\mathrm{M}_{i} = {\left(\frac{{\mathrm{gamma}_{i}}^{\mathrm{eta}_{i}} \cdot \mathrm{delta\_m}_{i} \cdot \mathrm{pq}_{i}}{\left(1.0 + \mathrm{chi}_{i} + \mathrm{tau\_m}_{i}\right) \cdot \mathrm{pm}_{i}}\right)}^{\frac{1.0}{1.0 - \mathrm{eta}_{i}}} \cdot \mathrm{Q}_{i}
$$
...
$$
\mathrm{RT}_{i} = \mathrm{chi}_{i} \cdot \mathrm{pm}_{i} \cdot \mathrm{M}_{i}
$$

`quota.eqchi1[BRD]`

$$
\mathrm{chi}_{i} \cdot \left(\mathrm{Mquota}_{i} - \mathrm{M}_{i}\right) = 0.0
$$
