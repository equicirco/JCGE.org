...
$$
\mathrm{M}_{i} = (\frac{\mathrm{gamma}_{i}^{\mathrm{eta}_{i}} \cdot \mathrm{delta\_m}_{i} \cdot \mathrm{pq}_{i}}{(1 + \mathrm{chi}_{i} + \mathrm{tau\_m}_{i}) \cdot \mathrm{pm}_{i}})^{\frac{1}{(1 - \mathrm{eta}_{i})}} \cdot \mathrm{Q}_{i}
$$
