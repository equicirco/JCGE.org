...
function model(; sam_table::Union{Nothing,JCGECalibrate.SAMTable} = nothing,
    ...
    price_block = JCGEBlocks.exchange_rate_link(:prices, commodities)

    bop_block = JCGEBlocks.external_balance_var_price(:bop, commodities, (Sf = start.Sf,))
    ...
    foreign_block = JCGEBlocks.foreign_trade(:foreign_trade, commodities, foreign_params)
