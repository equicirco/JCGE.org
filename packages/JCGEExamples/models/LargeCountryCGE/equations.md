...
$$
Td = tau\_d \cdot \left(\sum_{h \in \{\mathrm{CAP}, \mathrm{LAB}\}} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} + 0.0 + 0.0\right)
$$
...
$$
Sp = ssp \cdot \left(\sum_{h \in \{\mathrm{CAP}, \mathrm{LAB}\}} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} + 0.0 + 0.0\right)
$$
...
$$
\mathrm{Xp}_{i} = \frac{\mathrm{alpha}_{i} \cdot \left(\sum_{h \in \{\mathrm{CAP}, \mathrm{LAB}\}} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} - Sp - Td + 0.0 + 0.0\right)}{\mathrm{pq}_{i}}
$$
...
$$
\frac{\mathrm{E}_{i}}{\mathrm{E0}_{i}} = {\left(\frac{\mathrm{pWe}_{i}}{\mathrm{pWe0}_{i}}\right)}^{-\mathrm{sigma}_{i}}
$$

`foreign_trade.eqfm[BRD]`

$$
\frac{\mathrm{M}_{i}}{\mathrm{M0}_{i}} = {\left(\frac{\mathrm{pWm}_{i}}{\mathrm{pWm0}_{i}}\right)}^{\mathrm{psi}_{i}}
$$
