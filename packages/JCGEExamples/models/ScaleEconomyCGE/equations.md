...
$$
\mathrm{pz}_{i} = \mathrm{ay}_{i} \cdot \mathrm{py}_{i} + \sum_{j \in \mathcal{D}_{j}} \mathrm{ax}_{j,i} \cdot \mathrm{pq}_{j} + \mathrm{FC}_{i} / \mathrm{Z}_{i}
$$
...
$$
\mathrm{Xp}_{i} = \mathrm{alpha}_{i} \cdot (\sum_{h \in \mathcal{D}_{h}} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} - Sp - Td + 0 + \sum_{j \in \mathcal{D}_{j}} \mathrm{FC}_{j}) / \mathrm{pq}_{i}
$$
