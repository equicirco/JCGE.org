...
$$
\mathrm{D}_{i} = {\left(\frac{{\mathrm{gamma}_{i}}^{\mathrm{eta}_{i}} \cdot \mathrm{delta\_d}_{i} \cdot \mathrm{pq}_{i}}{\mathrm{pd\_scale}_{i} \cdot \mathrm{pd}_{i}}\right)}^{\frac{1.0}{1.0 - \mathrm{eta}_{i}}} \cdot \mathrm{Q}_{i}
$$
...
$$
\mathrm{RT}_{i} = \left(\frac{1.0 - \mathrm{eta}_{i}}{\mathrm{eta}_{i}}\right) \cdot \mathrm{pd}_{i} \cdot \mathrm{D}_{i}
$$
