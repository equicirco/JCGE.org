...
$$
\mathrm{Xp}_{i} = \mathrm{alpha}_{i} \cdot (\sum_{h \in \mathcal{D}_{h}} \mathrm{pf}_{h} \cdot \mathrm{FF}_{h} - Sp - Td + \sum_{j \in \mathcal{D}_{j}} \mathrm{RT}_{j} + 0) / \mathrm{pq}_{i}
$$
...
$$
\mathrm{D}_{i} = ({\mathrm{gamma}_{i}}^{\mathrm{eta}_{i}} \cdot \mathrm{delta\_d}_{i} \cdot \mathrm{pq}_{i} / \mathrm{pd\_scale}_{i} \cdot \mathrm{pd}_{i})^{1/((1 - \mathrm{eta}_{i}))} \cdot \mathrm{Q}_{i}
$$
...
$$
\mathrm{RT}_{i} = ((1 - \mathrm{eta}_{i}) / \mathrm{eta}_{i}) \cdot \mathrm{pd}_{i} \cdot \mathrm{D}_{i}
$$
